      ...
      body: BlocBuilder<HomeCubit, HomeState>(
        builder: (context, state) {
          ...
          return Directionality(
            ...
            child:
                state is HomeCategoriesLoaded ? const Center(child: Loading(),) :
            ListView(
              ...
              children: [
                ...
                Row(
                  children: [
                    TextWidget(
                        title: "اهلا ${getIt<CacheService>().getUserData()?.userName??""} !",
                        titleSize: 24.sp,
                  ...
                  children: [
                    Expanded(
                      child: CustomFormField(
                        ...
                        onChange: (value) {
                          cubit.searchPort(searchKey: value);
                          cubit.searchCategory(searchKey: value);
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                16.verticalSpace,
                                TextWidget(
                                  title:cubit.searchCategories?[index].categoryName?? "حبوب و بقوليات",
                                  titleSize: 18.sp,
                            ...
                            16.horizontalSpace,
                            ImageWidget(
                              imageUrl: cubit.searchCategories![index].image!.isEmpty?
                              "assets/images/cat.png": cubit.searchCategories?[index].image??"",
                              width: 120.w,
                              height: 200.h,
                            ),
                          ],
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                16.verticalSpace,
                                TextWidget(
                                  title: cubit.searchPorts?[index].portName??"منافذ  هيئة التضامن الاجتماعي",
                                  titleSize: 18.sp,
                                  titleFontWeight: FontWeight.bold,
                                  titleColor: AppColors.black,
                                ),
                                5.verticalSpace,
                                TextWidget(
                                  title:"محافظة ${ cubit.searchPorts?[index].governorate??""}",
                                  titleSize: 15.sp,
